...
This repository gives the open-source code of the experiments described in the paper, together with 3D shapes of the parts that need to be 3D-printed. Code is a [ROS package](https://github.com/ymollard/APEX/tree/master/ros/apex_playground).
