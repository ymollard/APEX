...
class Perception(object):
    def __init__(self):
        ...
        self.prefix = 'ergo'
        self.button_leds_topic = ['button_leds/help', 'button_leds/pause']
        ...
        self.button_leds_state = {topic: False for topic in self.button_leds_topics}
    ...
    def switch_led(self, topic, value=None):
        ...
        self.publishers.publish(topic, Bool(data=self.button_leds_status[topic]))
