...
from nips2017.srv import UpdateWorkStatus, GetWork, GetWorkResponse, UpdateWorkStatusResponse
...
class WorkManager(object):
    def __init__(self, outside_ros=False):
        ...
        self.experiment_file = join(self.rospack.get_path('nips2017'), 'config', 'experiment.json')
